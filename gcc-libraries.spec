...
%if 0%{?rhel} < 7
	--with-mpc=%{_builddir}/gcc-%{gcc_version}-%{DATE}/obj-%{gcc_target_platform}/mpc-install \
%endif
...
* Tue Aug  7 2018 Marek Polacek <polacek@redhat.com> 8.2.1-1.2.1
- rebase to GCC 8.2.1, include libgfortran[45] (#1600266)
